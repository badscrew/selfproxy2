...
# server on Ubuntu 20.04, 22.04, or 24.04 LTS.
#
# Features:
...
get_network_interface() {
    ...
    if [[ -z "$NET_INTERFACE" ]]; then
        ...
        read -p "Please enter your network interface (e.g., eth0, ens3): " NET_INTERFACE
    fi
...
print_summary() {
    ...
    echo
    print_success "WireGuard VPN server is now running"
    echo
...
main() {
    ...
    print_info "on Ubuntu 20.04, 22.04, or 24.04 LTS"
    echo
