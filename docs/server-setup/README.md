...
wget https://raw.githubusercontent.com/badscrew/selfproxy2/refs/heads/master/docs/server-setup/setup-wireguard.sh
...
wget https://raw.githubusercontent.com/badscrew/selfproxy2/refs/heads/master/docs/server-setup/setup-wireguard-amazon.sh
...
```bash
# Download and run the script
wget https://raw.githubusercontent.com/badscrew/selfproxy2/tree/master/docs/server-setup/setup-vless.sh
...
```bash
# Download and run the Amazon Linux script
wget https://raw.githubusercontent.com/badscrew/selfproxy2/tree/master/docs/server-setup/setup-vless-amazon.sh
